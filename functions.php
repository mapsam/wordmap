...
// queue up the your stylesheets, site.js and mapbox scripts
function points_script_queue() {
	wp_enqueue_style( 'site-css',  get_stylesheet_uri() );
	wp_enqueue_script( 'site-js',  get_template_directory_uri() . '/site.js', array('jquery') );
}
add_action( 'wp_enqueue_scripts', 'points_script_queue' );

/*
POINT custom post type
This will show up in your wp-admin with two meta boxes: 1) Latitude, and 2) Longitude
*/
...
/* Do not add anything beneath this! */